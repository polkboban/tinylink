      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col justify-between transition-all duration-300 z-20 relative">
        <div>
          <div className="h-16 flex items-center px-6 border-b border-gray-100">
            <span 
              className="text-2xl font-black text-orange-600 tracking-tighter cursor-pointer"
              onClick={() => navigate('/')}
            >
              tinylink
            </span>
          ...
          <div className="p-4">
            <button className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-colors mb-8 shadow-md shadow-blue-200">
              <Plus size={20} />
              Create new
            </button>
        ...
        <div className="p-4 border-t border-gray-100 relative">
          ...
          {isProfileOpen && (
            <>
              ...
              <div className="absolute bottom-[calc(100%+8px)] left-4 w-[calc(100%-2rem)] bg-white border border-gray-100 rounded-xl shadow-xl py-2 z-40 animate-in fade-in slide-in-from-bottom-2 duration-200">
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-[1.5rem] shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <p className="text-xs text-gray-400 mt-2 font-medium">+0% from last month</p>
              </div>
            ...
            <div className="bg-white rounded-[1.5rem] shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-16 text-center flex flex-col items-center justify-center">
                ...
                <button className="bg-[#001837] hover:bg-gray-800 text-white font-bold py-3 px-8 rounded-xl transition-colors shadow-lg">
                  Shorten a link
                </button>
              </div>
            </div>
