...
import DashShortener from '../components/DashShortener';
...
export default function DashboardPage() {
  ...
  const fetchUserLinks = async (id) => {
    try {
      const response = await fetch(`http://localhost:3000/api/urls/user/${id}`);
          ...
          <div className="p-4 mt-6">
            ...
            <nav className="space-y-2">
                <button 
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 text-sm font-bold rounded-lg transition-colors ${
                    activeTab === 'dashboard' ? 'text-blue-700 bg-blue-50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                    }`}
                >
                ...
                <button 
                    ...
                    activeTab === 'links' ? 'text-blue-700 bg-blue-50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                    }`}
                >
                ...
                <button 
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 text-sm font-semibold rounded-lg transition-colors ${
                    activeTab === 'qrcodes' ? 'text-blue-700 bg-blue-50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                    }`}
                >
          ...
          <div className="max-w-9xl mx-auto space-y-8">
            ...
            {activeTab === 'links' && (
                <div className="bg-white p-8 rounded-[1.5rem] shadow-sm border border-gray-100">
                    <h2 className="text-2xl font-extrabold text-gray-800 mb-6">Links History & Analytics</h2>
                    {/* We will build the LinksHistory component here */}
                    <p>Links component coming soon...</p>
                </div>
                )}

                {activeTab === 'qrcodes' && (
                <div>
                    <h2 className="text-2xl font-extrabold text-gray-800 mb-6">QR Code Studio</h2>
                    <DashboardQRCode />
                </div>
                )}
          </div>
